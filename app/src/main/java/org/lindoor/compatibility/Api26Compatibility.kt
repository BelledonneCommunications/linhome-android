...
class Api26Compatibility {
    companion object {
        ...
        fun createServiceChannel(context: Context, notificationManager: NotificationManagerCompat) {
            ...
            val id = Texts.get("notification_channel_service_id")
            val name: CharSequence = Texts.get("notification_channel_service_name")
            val description = Texts.get("notification_channel_service_name")
            val channel =
        ...
        fun createIncomingCallChannel(
            ...
            val id = Texts.get("notification_channel_incoming_call_id")
            val name = Texts.get("notification_channel_incoming_call_name")
            val description = Texts.get("notification_channel_incoming_call_name")
            val channel =
                NotificationChannel(id, name, NotificationManager.IMPORTANCE_HIGH)
            channel.description = description
            channel.lightColor = Theme.getColor("notification_led_color")
